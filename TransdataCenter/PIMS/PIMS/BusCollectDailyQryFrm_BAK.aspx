<%@ Page Title="" Language="C#" MasterPageFile="~/PIMSSite.Master" AutoEventWireup="true"
    CodeFile="BusCollectDailyQryFrm_BAK.aspx.cs" Inherits="BusCollectDailyQryFrm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/车辆收银日报表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
