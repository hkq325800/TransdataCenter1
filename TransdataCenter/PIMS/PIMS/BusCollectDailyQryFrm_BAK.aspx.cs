...
public partial class BusCollectDailyQryFrm : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        xrf.detailFields = new string[] { "BUSUNITNAME", "PLANBUSNUMBER", "ACTUALCOLLECTNUMBER", "NOCOLLECTNUMBER", "ACTUALBAGNUMBER", "BUSSELFNO" };

        xrf.ShowReportTitle("停车场收银日报表", "集团公司场站管理处", System.DateTime.Now.ToLongDateString());

        xrf.ReportHeader = new string[] { "单位", "计划车辆数", "实际收银车辆数", "未收银车辆数", "实际钱袋数", "未收银车辆车号" };
      ...
      //  xrf.MergeCells = new string[] { "BUSUNITNAME", "PLANBUSNUMBER", "ACTUALCOLLECTNUMBER", "NOCOLLECTNUMBER", "ACTUALBAGNUMBER" }; //设置需要行单元格合并的字段
            ...
            strWhere.Append(" 0");
            DataSet ds = pimsqry.GetPIMSCollectDataByWhereSelStr(" t1.ACTUALBAGNUMBER,t1.ACTUALCOLLECTNUMBER ,t1.NOCOLLECTNUMBER,t1.PLANBUSNUMBER,t2.BUSSELFNO,t1.BUSUNITNAME",
