...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/收银员工作日统计表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
                ...
                <tr>
                    ...
                    <%--<td class="style2">
                        <asp:RadioButtonList ID="rbl" runat="server" 
                            ...
                            <asp:ListItem Selected="True" Value="stat">已统计</asp:ListItem>
                            <asp:ListItem Value="nostat">未统计</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>--%>
                    <td>
