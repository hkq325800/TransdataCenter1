<%@ Page Title="" Language="C#" MasterPageFile="~/PIMSSite.Master" AutoEventWireup="true"
    CodeFile="CollecterMonthStatQryFrm.aspx.cs" Inherits="CollecterMonthStatQryFrm" %>
...
<%@ Register src="../CommCtrl/uc_MonthConvert.ascx" tagname="uc_MonthConvert" tagprefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/收银员工作月统计表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <uc2:uc_MonthConvert ID="uc_MonthConvert1" runat="server" />
