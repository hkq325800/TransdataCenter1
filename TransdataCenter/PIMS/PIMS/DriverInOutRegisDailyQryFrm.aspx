<%@ Page Title="" Language="C#" MasterPageFile="~/PIMSSite.Master" AutoEventWireup="true"
    CodeFile="DriverInOutRegisDailyQryFrm.aspx.cs" Inherits="DriverInOutRegisDailyQryFrm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/司乘人员进出场登记表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
