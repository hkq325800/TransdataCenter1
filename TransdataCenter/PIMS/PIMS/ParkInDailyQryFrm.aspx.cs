...
public partial class ParkInDailyQryFrm : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        xrf.ShowReportTitle("车辆进场日报表", "制表：", System.DateTime.Now.ToLongDateString());
        xrf.ReportHeader = new string[] { "线路", "车号", "进场时间" };
