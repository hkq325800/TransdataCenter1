<%@ Page Title="" Language="C#" MasterPageFile="~/PIMSSite.Master" AutoEventWireup="true"
    CodeFile="ParkOutDelayDetailQryFrm.aspx.cs" Inherits="ParkOutDelayDetailQryFrm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/延误出场明细表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
