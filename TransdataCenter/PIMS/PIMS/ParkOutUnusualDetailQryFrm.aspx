<%@ Page Title="" Language="C#" MasterPageFile="~/PIMSSite.Master" AutoEventWireup="true"
    CodeFile="ParkOutUnusualDetailQryFrm.aspx.cs" Inherits="ParkOutUnusualDetailQryFrm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="d2" style="background-image: url('../images/车辆非正常出场明细表.gif'); background-repeat: no-repeat;
        height: 44px;">
    </div>
